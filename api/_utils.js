...
export function configSummary() {
  return {
    ...
    durationSec: clampNum(process.env.YT_DURATION_SEC || 720, 300, 1200, 720),
...
export function buildQueueItem(input) {
  ...
  return {
    ...
    durationSec: clampNum(input.durationSec || process.env.YT_DURATION_SEC || 720, 300, 1200, 720),
    ...
    resolution: clampStr(input.resolution || "1080p", 10),
