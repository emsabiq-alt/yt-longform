...
function buildPrompt(input, wiki = null) {
  ...
  return [
    ...
    "ATURAN DIVERSIFIKASI VISUAL & B-ROLL (SANGAT KETAT — ANTI-MONOTON):",
    "  - DILARANG KERAS mengulang jenis subjek/latar visual yang sama lebih dari 2 scene di seluruh naskah video.",
    "    (Contoh terlarang: jangan menampilkan ombak laut, pemandangan air, kawah gunung, atau ruang kantor yang itu-itu terus di belasan scene).",
    "  - Di setiap bab (chapter), WAJIB merotasi 5 PILAR PERSPEKTIF VISUAL berikut secara bergantian:",
    "    1. PILAR KARTOGRAFI & SATELIT: Peta batimetri laut dalam, citra radar deformasi satelit InSAR, kontur patahan sesar aktif, peta navigasi/pelayaran kuno.",
    "    2. PILAR DIAGRAM ANATOMI GEOLOGI 3D: Irisan melintang kerak bumi, kantong dapur magma pijar di kedalaman mantel, zona penunjaman subduksi lempeng, retakan litosfer.",
    "    3. PILAR INSTRUMEN & DATA SAINS: Jarum seismograf analog/digital merekam tremor gempa, sensor pelampung (buoy) tsunami samudra, monitor radar stasiun geofisika, layar simulasi model komputer penjalaran gelombang.",
    "    4. PILAR ARSIP SEJARAH & JEJAK FISIK: Singkapan lapisan abu vulkanik purba (tephra) di tebing tanah, inti bor batuan geologi, dokumen litografi surat kabar bersejarah, jejak peradaban yang terkubur lahar.",
    "    5. PILAR AKSI DINAMIS & LAPANGAN: Ahli geologi memeriksa sampel batuan di alam terbuka, kapal riset oseanografi dengan sistem multibeam sonar, sirene peringatan dini tsunami di pesisir, tim evakuasi darurat.",
    "  - pexelsQuery dan visualKeywords HARUS KONKRET, SPESIFIK, dan LANGSUNG MENGACU pada instrumen, data, atau aksi yang sedang dibahas di narasi scene:",
    "    * Contoh BAGUS: 'seismograph recording needle earthquake', 'geologist inspecting rock layers outdoors', 'radar satellite screen monitoring earth', 'tsunami warning siren coastal post', 'ocean research vessel sonar seabed', 'ancient newspaper lithograph archive', 'volcanic ash plume cloud eruption'.",
    "    * Contoh BURUK & TERLARANG: 'ocean waves aerial' (terlalu generik/berulang), 'calm ocean water' (membosankan), 'water surface' (terlarang), 'documentary footage' (terlalu abstrak), 'digital technology' (tidak bermakna).",
    "  - mustMatchTerms WAJIB berupa kata benda teknis/objek konkret yang benar-benar dibahas di narrativeContext (misal: ['seismograph'], ['radar'], ['fault'], ['satellite'], ['siren'], ['buoy'], ['crater'], ['rock', 'geologist']), BUKAN cuma kata umum ['ocean'] atau ['water'].",
